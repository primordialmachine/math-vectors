...
// M is a matrix type.
template<typename M>
struct binary_minus_functor<M, M, enable_if_t<is_matrix_v<M>>>
  : public default_elementwise_binary_minus_functor<M, M>
{}; // struct binary_minus_functor

// Case of a -= b where a and b are of type M.
// M is a matrix type.
template<typename M>
struct minus_assignment_functor<M, M, enable_if_t<is_matrix_v<M>>>
  : public default_elementwise_minus_assignment_functor<M, M>
