...
TEST(vectors_tests, dot_product_functor_vector_3_vector_3_test)
{
  using namespace primordialmachine;
  auto value = dot_product(vector_type(2.f, 3.f, 5.f), vector_type(7.f, 9.f, 11.f));
  auto result = (2.f * 7.f + 3.f * 9.f + 5.f * 11.f) == value;
  ASSERT_TRUE(result);
}
