...
auto
cross_product(const LEFT_OPERAND& u, const RIGHT_OPERAND& v)
  -> decltype(cross_product_functor<LEFT_OPERAND, RIGHT_OPERAND>()(u, v))
{
  return cross_product_functor<LEFT_OPERAND, RIGHT_OPERAND>()(u, v);
}
