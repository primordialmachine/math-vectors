...
#include "primordialmachine/vectors/vector.hpp"
#include <type_traits>
...
#define CONSTRUCTOR_CONDITION()                                                \
  std::enable_if_t<CONSTRUCTOR_CONDITION_1(TRAITS::dimensionality) &&          \
...
struct vector<TRAITS, STRUCT_CONDITION()>
{
  ...
  template<size_t NUMBER_OF_ELEMENTS_ = TRAITS::dimensionality>
  constexpr std::enable_if_t<(NUMBER_OF_ELEMENTS_ >= 1), element_type> const& x() const;
  template<size_t NUMBER_OF_ELEMENTS_ = TRAITS::dimensionality>
  constexpr std::enable_if_t<(NUMBER_OF_ELEMENTS_ >= 1), element_type>& x();

  template<size_t NUMBER_OF_ELEMENTS_ = TRAITS::dimensionality>
  constexpr std::enable_if_t<(NUMBER_OF_ELEMENTS_ >= 2), element_type> const& y() const;
  template<size_t NUMBER_OF_ELEMENTS_ = TRAITS::dimensionality>
  constexpr std::enable_if_t<(NUMBER_OF_ELEMENTS_ >= 2), element_type>& y();

  template<size_t NUMBER_OF_ELEMENTS_ = TRAITS::dimensionality>
  constexpr std::enable_if_t<(NUMBER_OF_ELEMENTS_ >= 3), element_type> const& z() const;
  template<size_t NUMBER_OF_ELEMENTS_ = TRAITS::dimensionality>
  constexpr std::enable_if_t<(NUMBER_OF_ELEMENTS_ >= 3), element_type>& z();
...
private:
  element_type m_elements[dimensionality];
};
...
TYPE::vector()
  : m_elements{}
{
  std::fill_n(m_elements, dimensionality, zero<element_type>());
}
...
constexpr std::enable_if_t<(NUMBER_OF_ELEMENTS_ >= 1), typename TYPE::element_type> const&
TYPE::x() const
{
  return m_elements[0];
}
...
template<typename TRAITS>
template<size_t NUMBER_OF_ELEMENTS_>
constexpr std::enable_if_t<(NUMBER_OF_ELEMENTS_ >= 1), typename TYPE::element_type>&
TYPE::x()
{
  return m_elements[0];
}
...
template<typename TRAITS>
template<size_t NUMBER_OF_ELEMENTS_>
constexpr std::enable_if_t<(NUMBER_OF_ELEMENTS_ >= 2), typename TYPE::element_type> const&
TYPE::y() const
{
  return m_elements[1];
}
...
template<typename TRAITS>
template<size_t NUMBER_OF_ELEMENTS_>
constexpr std::enable_if_t<(NUMBER_OF_ELEMENTS_ >= 2), typename TYPE::element_type>&
TYPE::y()
{
  return m_elements[1];
}
...
template<typename TRAITS>
template<size_t NUMBER_OF_ELEMENTS_>
constexpr std::enable_if_t<(NUMBER_OF_ELEMENTS_ >= 3),typename TYPE::element_type> const&
TYPE::z() const
{
  return m_elements[2];
}
...
template<typename TRAITS>
template<size_t NUMBER_OF_ELEMENTS_>
constexpr std::enable_if_t<(NUMBER_OF_ELEMENTS_ >= 3), typename TYPE::element_type>&
TYPE::z()
{
  return m_elements[2];
}
